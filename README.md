...
_2024年3月_に法政大学理工学部を卒業後、株式会社千葉銀行にAI/MLエンジニアとして入行。約1年半にわたり、生成AI（LLM）と画像認識を活用した業務効率化プロジェクトを、企画立案からモデル開発、アプリケーション運用まで一貫して主導。具体的には、
...
_2024年4月~10月_：株式会社千葉銀行（デジタル戦略部）:デジタル戦略部内の業務の全体感を知るため、業務改革G・デジタルチャネルG・マーケティング戦略Gの３グループでOJTを経験。

_2024年10月~11月_:Google、出向([Google's Advanced Solutions Lab ML Immersive Education](https://cloud.google.com/customers/chiba-bank?hl=ja))：４週間の内、最初の３週間で、tensorflowの実装や機械学習の理論を学び、最終週で、各自が持ってきたプロジェクトのプロトタイプを開発する研修を経験。本プロトタイプでは、日本手話のプロトタイプを作成。

_2024年11月~現在_：株式会社千葉銀行、正社員（デジタル戦略部AIソリューション室　AI/MLエンジニア）

_2025年12月~現在_：株式会社エッジテクノロジー、出向（イノベーション推進室　AI/MLエンジニア・データサイエンティスト）

## 職務経歴(所属企業)

| 期間 | 企業 / 組織 | 役割 / プロジェクト |
| :--- | :--- | :--- |
| 2024/04 – 2024/10 | 株式会社千葉銀行<br>デジタル戦略部 | OJT研修（業務改革・デジタルチャネル・マーケティング） |
| 2024/10 – 2024/11 | Google<br>ASL ML Immersive Education | 外部出向（Machine Learning 集中研修） |
...
* **株式会社千葉銀行 (2024/04 – 2024/10)**
    * デジタル戦略部内の3グループ（業務改革・デジタルチャネル・マーケティング戦略）にてOJTを経験。銀行業務の全体像とデジタル化の課題を深く理解。
* **Google 外部出向 (2024/10 – 2024/11)**
    ...
    * **成果:** 最終週のプロジェクトにて「日本手話（JSL）」の認識プロトタイプを独自開発。
* **株式会社千葉銀行 AIソリューション室 (2024/11 – 2025/12)**
    * AI/MLエンジニアとして、行内の業務効率化やデータ活用プロジェクトに従事。
* **エッジテクノロジー株式会社 外部出向 (2025/12 – 現在)**
    * イノベーション推進室にて、AI/MLエンジニアおよびデータサイエンティストとして、より高度なアルゴリズム実装や新規ソリューションの開発を担当。
